...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/dhruvagrawal27/insta-downloader-gui.git
   ```
...
1. Check existing [issues](https://github.com/dhruvagrawal27/insta-downloader-gui/issues) and [pull requests](https://github.com/dhruvagrawal27/insta-downloader-gui/pulls) to avoid duplicates.
